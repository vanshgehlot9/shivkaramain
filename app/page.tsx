...
function SpecialOffers({ onClaimOffer }: { onClaimOffer: () => void }) {
  return (
    <motion.section
...
function Pricing({ onCustomQuote }: { onCustomQuote: () => void }) {
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <Projects />
      <Testimonials />
        <SpecialOffers onClaimOffer={() => setIsClaimOfferModalOpen(true)} />
        <Pricing onCustomQuote={() => setIsCustomQuoteModalOpen(true)} />
      <Team />
      <Blog />
      <FAQ />
      <Contact />
      ...
      <Modal
        ...
        onClose={() => setIsClaimOfferModalOpen(false)}
      ...
      >
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-2">Claim Your Special Offer</h3>
            <p className="text-gray-600">Limited time offer - Get 20% off your first project!</p>
          </div>
          <ContactForm />
        </div>
      </Modal>
